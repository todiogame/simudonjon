...
class DonjonDeck:
    def __init__(self):
        self.cartes = [
            ...
            CarteMonstre("Mimique", 0, [], "La <b>puissance</b> de ce monstre est égale au nombre d'objets intacts que vous possédez quand vous la rencontrez.", "MIMIC", is_X=True),
            ...
            CarteMonstre("Saigneur Vampire", 4, ["Vampire"], "Inflige <b>2 dommages supplémentaires</b> pour <b>chaque Médaille</b> que vous possédez.",  "LORD"),
            ...
            CarteEvent("Echoppe Secrete", "Si vous avez <b>moins de 4</b> objets intacts, <b>piochez</b> un objet. Sinon vous pouvez vous <b>défausser</b> d'un objet intact pour en <b>repiocher</b> un.", "SHOP"),
            CarteEvent("Injection argileuse", "Les joueurs gagnent <b>2 PV</b> pour chaque <b>Golem</b> dans leur pile.", "INJECTION"),
            ...
            CarteEvent("Traquenard", "Si la prochaine carte du Donjon est un monstre, si vous <b>l'exécutez</b>, perdez <b>3 PV</b>.", "TRAP"),
            CarteEvent("Roue de l'infortune", "Vous pouvez <b>défausser</b> un monstre pour lancer le dé, et <b>gagner autant de PV</b>.", "FORTUNE_WHEEL"),
        ]
